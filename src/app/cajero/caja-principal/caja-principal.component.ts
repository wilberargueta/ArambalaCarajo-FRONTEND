...
@Component({
  selector: 'ac-caja-principal',
  templateUrl: './caja-principal.component.html',
  styleUrls: ['./caja-principal.component.scss']
})
export class CajaPrincipalComponent implements OnInit {
